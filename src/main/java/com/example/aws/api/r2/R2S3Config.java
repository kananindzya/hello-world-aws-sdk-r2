...
public class R2S3Config {
    ...
    @Bean
    public AmazonS3 s3client(@Value("${r2.endpoint}") String r2ServiceEndpoint,
        ...
        AwsClientBuilder.EndpointConfiguration endpointConfiguration = new AwsClientBuilder.EndpointConfiguration(accountR2Url, null);
